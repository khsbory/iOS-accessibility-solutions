...
class CarouselAccessibilityMainViewController: UIViewController {
    ...
    private func setScreenTitle() {
        ...
        self.title = "캐러셀 접근성 테스트"
    }
    
    @IBAction func launchDemoWithoutAccessibility(_ sender: Any) {
        Constants.isAccessibilityApplied = false
        showScreenOnOtherStoryboard(storyboardName: "CarouselAccessibility", viewControllerStoryboardId: "exceptional_accessibility")
    }
